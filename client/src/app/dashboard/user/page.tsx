    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // The wishlist endpoint returns IDs, I usually need populated data to show cards.
                // Step 384/397 code was: `User.findById(req.user.id).populate('favorites')`
                // So it returns populated objects. Correct.
